          ...
          {FIBONACCI_DECK.map((val) => {
            ...
            return (
              <button
                ...
                className={`w-11 h-16 sm:w-12 sm:h-18 rounded-xl font-black text-base sm:text-lg flex flex-col justify-between p-1.5 transition-all duration-200 select-none shadow-md flex-shrink-0 ${
                  isSelected
