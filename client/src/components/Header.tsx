...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="border-b border-blue-200/60 bg-white/80 backdrop-blur-md px-4 sm:px-6 py-2.5 flex items-center justify-between sticky top-0 z-40 shadow-xs">
